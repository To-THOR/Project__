...
#define	CIRCLE_SPEED_FACTOR_1			((int)(1+((float)(2*WHEEL_GAP))/((float)(2*FIGURE_SIZE_1-WHEEL_GAP))))
#define	CIRCLE_SPEED_FACTOR_2			((int)(1+((float)(2*WHEEL_GAP))/((float)(2*FIGURE_SIZE_2-WHEEL_GAP))))
#define	CIRCLE_SPEED_FACTOR_MAX			((int)(1+((float)(2*WHEEL_GAP))/((float)(2*FIGURE_SIZE_MAX-WHEEL_GAP))))
