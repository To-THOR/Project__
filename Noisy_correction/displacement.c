...
#define	CIRCLE_SPEED_1					((uint32_t)(((float)(NORMAL_SPEED))*CIRCLE_SPEED_FACTOR_1))
#define	CIRCLE_SPEED_2					((uint32_t)(((float)(NORMAL_SPEED))*CIRCLE_SPEED_FACTOR_2))
#define	CIRCLE_SPEED_MAX				((uint32_t)(((float)(NORMAL_SPEED))*CIRCLE_SPEED_FACTOR_MAX))
